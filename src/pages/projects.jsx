...
const projects = [
  {
    name: 'Plexus',
    description:
      'Everything you need to provide wellness benefits. Keep your employees happy and covered with the freedom to customize their benefits. Built using Next, Tailwind, Supabase.',
    link: {
      href: 'https://plexus-lake.vercel.app',
      label: 'plexus-lake.vercel.app',
    },
    logo: logoPlexus,
  },
  {
  ...
  // {
  //   name: 'boring articles',
  //   description:
  //     'AI that edits articles to remove bias. It detects falsehoods and sentiment to give you a boring article and more confidence in the truth.',
  //   link: { href: '#', label: 'github.com' },
  //   logo: logoBoringArticles,
  // },
]
